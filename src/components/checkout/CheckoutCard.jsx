...
const CheckoutCard = async ({ item, currency }) => {
  const { updateItemQuantity } = useCart();

  return (
    <div className="group w-full h-auto flex justify-start items-center py-2 px-5 border-b hover:bg-white transition-all border-gray-100 relative last:border-b-0">
