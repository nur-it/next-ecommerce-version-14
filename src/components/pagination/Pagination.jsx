...
export const NavigationButton = ({ onClick, disabled, directionIcon }) => {
  ...
  return (
    <button
      ...
      className="align-bottom inline-flex items-center justify-center cursor-pointer leading-5 transition-colors duration-150 font-medium p-2 rounded-md text-gray-800 focus:outline-none border border-transparent active:bg-transparent hover:bg-gray-100"
    >
      <Icon />
    </button>
  );
...
export const PageButton = function PageButton({ page, isActive, onClick }) {
  return (
    <button
      ...
      className={`${
        isActive
          ? "bg-emerald-600 text-white font-normal hover:text-gray-800"
          : "text-gray-900"
      } align-bottom inline-flex items-center justify-center cursor-pointer leading-5 transition-colors duration-150 font-medium px-3 py-1 rounded-md text-xs text-gray-600 focus:outline-none border border-transparent active:bg-transparent hover:bg-gray-100`}
    >
      {page}
    </button>
  );
...
const Pagination = React.forwardRef(function Pagination(props, ref) {
  ...
  return (
    <div className="px-4 pt-4 border-t border-gray-200 bg-white text-gray-500">
      <div
        className="flex flex-col justify-between text-xs sm:flex-row text-gray-600"
        ref={ref}
        {...other}
      >
        {/*
